function addMetaTags(day) {
	...
	var baseURL = window.location.origin + '/advent-of-code/2015/';
	...
	if (day !== undefined) {
		description =
			'Advent of Code 2015 Day ' + day + ' solution (JavaScript)';
		title = 'Day ' + day + ' - ' + title;
		url += 'day' + day;
	}
...
Solution = function (id, div) {
	...
	source.href =
		'https://github.com/BretHudson/advent-of-code/blob/main/2015/day' +
		id +
		'.html';
...
document.addEventListener('DOMContentLoaded', function (e) {
	if (!iframeContained()) {
		...
		subtitle.innerHTML =
			'Solutions by <a href="https://brethudson.com">Bret Hudson</a>';
